...
gulp.task('html', function() {
  ...
  return gulp.src('app/**/**/*.html')
    ...
    .pipe($.if('*.css', $.uncss({
      html: [
        'app/index.html','app/project-2048.html','app/project-mobile.html','app/project-webperf.html',
        'app/styleguide.html','app/views/pizza.html'
      ],
...
gulp.task('serve', ['styles'], function() {
  ...
  gulp.watch(['app/js/**/*.js','app/styleguide/**/*.js','app/views/**/*.js'], ['jshint']);
